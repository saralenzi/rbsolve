...
F77COMP	=	gfortran
LINKER =	gfortran
CFLAGS =       -O3 -ffixed-line-length-none
...
#F77COMP =       ifort
#LINKER =        ifort
#CFLAGS =        -O3   -no-prec-div -mcmodel=medium -shared-intel -g
...
TEMPSPECT_OBJ    =       tempspect.o tools.o salva.o
tempspect: $(TEMPSPECT_OBJ)
	$(COMP)  $(CFLAGS) -D"NOMPI"  -o tempspect $(TEMPSPECT_OBJ) $(LDFLAGS)
